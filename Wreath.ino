...
*/
PROGMEM_ const unsigned char pwmMap[][2] = {
 
  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  
  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0xff },  { 0x01, 0x80 },  { 0x01, 0x80 },  
  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  
  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  { 0x01, 0x80 },  
  { 0x01, 0x80 },  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x40 },  
  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x40 },  { 0x01, 0x2a },  { 0x01, 0x2a },  
  { 0x01, 0x2a },  { 0x01, 0x2a },  { 0x01, 0x2a },  { 0x01, 0x2a },  { 0x01, 0x20 },  { 0x01, 0x20 },  
  { 0x01, 0x20 },  { 0x01, 0x20 },  { 0x01, 0x20 },  { 0x01, 0x19 },  { 0x01, 0x19 },  { 0x01, 0x19 },  
  { 0x01, 0x19 },  { 0x01, 0x15 },  { 0x01, 0x15 },  { 0x01, 0x15 },  { 0x01, 0x12 },  { 0x01, 0x12 },  
  { 0x01, 0x12 },  { 0x01, 0x10 },  { 0x01, 0x10 },  { 0x01, 0x10 },  { 0x01, 0x0e },  { 0x01, 0x0e },  
  { 0x01, 0x0c },  { 0x01, 0x0c },  { 0x01, 0x0b },  { 0x01, 0x0b },  { 0x01, 0x0a },  { 0x01, 0x0a },  
  { 0x01, 0x09 },  { 0x01, 0x09 },  { 0x01, 0x09 },  { 0x01, 0x08 },  { 0x01, 0x08 },  { 0x01, 0x08 },  
  { 0x01, 0x07 },  { 0x01, 0x07 },  { 0x01, 0x07 },  { 0x01, 0x06 },  { 0x01, 0x06 },  { 0x01, 0x06 },  
  { 0x01, 0x05 },  { 0x01, 0x05 },  { 0x01, 0x05 },  { 0x01, 0x05 },  { 0x01, 0x04 },  { 0x01, 0x04 },  
  { 0x01, 0x04 },  { 0x01, 0x04 },  { 0x01, 0x04 },  { 0x01, 0x04 },  { 0x01, 0x03 },  { 0x01, 0x03 },  
  { 0x01, 0x03 },  { 0x01, 0x03 },  { 0x01, 0x03 },  { 0x01, 0x03 },  { 0x01, 0x02 },  { 0x01, 0x02 }, 
  ...
  { 0x03, 0x01 },  { 0x03, 0x01 },  { 0x04, 0x01 },  { 0x04, 0x01 },  { 0x04, 0x01 },  { 0x04, 0x01 },  
  { 0x04, 0x01 },  { 0x04, 0x01 },  { 0x04, 0x01 },  { 0x05, 0x01 },  { 0x05, 0x01 },  { 0x05, 0x01 },  
  { 0x05, 0x01 },  { 0x05, 0x01 },  { 0x06, 0x01 },  { 0x06, 0x01 },  { 0x06, 0x01 },  { 0x06, 0x01 },  
  { 0x07, 0x01 },  { 0x07, 0x01 },  { 0x07, 0x01 },  { 0x08, 0x01 },  { 0x08, 0x01 },  { 0x08, 0x01 },  
  { 0x09, 0x01 },  { 0x09, 0x01 },  { 0x09, 0x01 },  { 0x0a, 0x01 },  { 0x0a, 0x01 },  { 0x0b, 0x01 },  
  { 0x0b, 0x01 },  { 0x0c, 0x01 },  { 0x0c, 0x01 },  { 0x0d, 0x01 },  { 0x0d, 0x01 },  { 0x0e, 0x01 },  
  { 0x0f, 0x01 },  { 0x0f, 0x01 },  { 0x10, 0x01 },  { 0x11, 0x01 },  { 0x11, 0x01 },  { 0x12, 0x01 },  
  { 0x12, 0x01 },  { 0x13, 0x01 },  { 0x13, 0x01 },  { 0x15, 0x01 },  { 0x15, 0x01 },  { 0x17, 0x01 },  
  { 0x17, 0x01 },  { 0x19, 0x01 },  { 0x19, 0x01 },  { 0x19, 0x01 },  { 0x1c, 0x01 },  { 0x1c, 0x01 },  
  { 0x1c, 0x01 },  { 0x20, 0x01 },  { 0x20, 0x01 },  { 0x20, 0x01 },  { 0x24, 0x01 },  { 0x24, 0x01 },  
  { 0x24, 0x01 },  { 0x24, 0x01 },  { 0x2a, 0x01 },  { 0x2a, 0x01 },  { 0x2a, 0x01 },  { 0x2a, 0x01 },  
  { 0x2a, 0x01 },  { 0x33, 0x01 },  { 0x33, 0x01 },  { 0x33, 0x01 },  { 0x33, 0x01 },  { 0x33, 0x01 },  
  { 0x33, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  
  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x40, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  
  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  
  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  { 0x55, 0x01 },  
  { 0x55, 0x01 },  { 0x80, 0x01 },  { 0x80, 0x01 },  { 0x80, 0x01 },  { 0x80, 0x01 },  { 0x80, 0x01 },  
    ...
    void output() {
      ...
      for (; i < no_of_pins; i++) {
        ...
        if ( this->ready_for_load ) {
          ...
          this->pwmIndex[i] = 0;
          this->pwmCnt[i] = 0;
          this->pwmPins[i] = pgm_read_byte_far(pwmMap[this->pwmIndex[i]]);
          this->pwmSignals[i] = 0;
        }
        ...
        if ( this->current[i] > 0 ) {
          ...
          if ( this->pwmCnt[i] == 0 ) {
            this->pwmIndex[i] = (++this->pwmIndex[i]) % pwmThrottle;
            
            if ( this->pwmIndex[i] <= halfThrottle ) {
              this->pwmPins[i] = (pwmThrottle - this->pwmIndex[i])/this->pwmIndex[i];
            }
            else {
              this->pwmPins[i] = (this->pwmIndex[i] - halfThrottle)/this->pwmIndex[i];
            }
          }
          
          if ( this->pwmCnt[i] <= halfThrottle ) {
             if ( this->pwmSignals[i] == 0 ) {
               this->pwmSignals[i] = 1; 
             }
             else if ( this->pwmCnt[i] == this->pwmPins[i] ) {
               this->pwmSignals[i] = 0;
             }
          }
          else {
             if ( this->pwmSignals[i] == 1 ) {
               this->pwmSignals[i] = 0; 
             }
             else if ( this->pwmCnt[i] == this->pwmPins[i] ) {
               this->pwmSignals[i] = 1;
...
void chooseJingleBells() {
  ...
  tempo.quarter_note = speeds[Andantino];
  tempo.thirtyTwo_note = tempo.quarter_note / 8;
  tempo.smallest_note = tempo.thirtyTwo_note;
  tempo.pwmTime = tempo.smallest_note / 4;
  tempo.ftime_factor = tempo.quarter_note;
